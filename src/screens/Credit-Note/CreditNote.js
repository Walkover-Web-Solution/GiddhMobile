    ...
    return (
      ...
      <View
        ...
        onPress={() => this.openCopyVoucherSheet()}>
          <FontAwesome5 name={'copy'} color={'#3497FD'} style={{ margin: 16 }} size={18} />
          <Text style={{ color: '#1C1C1C', marginRight: 16, fontFamily: 'AvenirLTStd-Book' }}>{this.props.t('common.Copy Previous Credit Notes')}</Text>
        </TouchableOpacity>
      </View>
      </>
    );
