...
class PaymentLinkToInvice extends React.Component<Props> {
  ...
  renderHeader() {
    return (
      <View style={[style.header, {backgroundColor: '#084EAD'}]}>
        <View style={{flexDirection: 'row', paddingVertical: 10, alignItems: 'center'}}>
          ...
          <Text style={style.invoiceType}>Link Payment to Invoice</Text>
        </View>
      </View>
    );
  }
  ...
  renderPartyName() {
    return (
      <View
        style={{backgroundColor: '#084EAD', flexDirection: 'row', minHeight: 50, alignItems: 'center'}}
        onPress={() => {}}>
  ...
  renderAmount() {
    return (
        <View style={{paddingHorizontal: 15, flexDirection: 'row', backgroundColor: '#084EAD'}}>
        ...
        <View style={{flexDirection: 'row', backgroundColor: '#E7F8F4', padding: 10, marginBottom: 10}}>
          ...
          <View style={{flex: 1}}>
            <View style={{flexDirection: 'row', flex: 1}}>
              ...
              <Text style={style.invoiceText}>{item.voucherNumber ? item.voucherNumber : 'N/A'}</Text>
              <Text
...
function Screen(props) {
  ...
  return <PaymentLinkToInvice {...props} isFocused={isFocused} />;
}
