    ...
    return (
      <TouchableOpacity
        ...
        <View style={{ flex: 1 }}>
          ...
          {voucherNumber ? (
            <View style={{ alignSelf: 'flex-start', backgroundColor: '#FDECE0', borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2, marginTop: 4 }}>
              <Text style={{ color: '#FC8345', fontFamily: FONT_FAMILY.semibold, fontSize: 12 }} numberOfLines={1}>{voucherNumber}</Text>
            </View>
          ) : null}
        </View>
