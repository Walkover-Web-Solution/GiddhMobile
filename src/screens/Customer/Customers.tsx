    ...
    return (
      <View style={{ justifyContent: "center", alignItems: "center" }}>
        <TouchableOpacity style={{ paddingVertical: 10, width: "90%", }}
          onPress={() => {
            this.setState({ isMobileModalVisible: false, selectedCallingCode: callingCode })
            this.setState({ isMobileNoValid: !this.validateMobileNumberTextInput(this.state.contactNumber) })
          }}>
