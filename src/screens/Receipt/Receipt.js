      ...
      <Modal
        ...
        <TouchableOpacity
          ...
          <View
            ...
            <Text
              style={[
                {fontFamily: FONT_FAMILY.bold, fontSize: 16, color: '#00B795', marginHorizontal: 20, margin: 10},
              ]}>
              {'Calculation Method'}
            </Text>
            ...
            <TouchableOpacity
                    onFocus={() => this.onChangeText('')}
                    style={{
                      backgroundColor: this.state.tdsTcsTaxCalculationMethod == 'OnTaxableAmount' ? '#00B79580' : '#fff',
                  ...
                  <TouchableOpacity
                    onFocus={() => this.onChangeText('')}
                    style={{
                      backgroundColor: this.state.tdsTcsTaxCalculationMethod == 'OnTotalAmount' ? '#00B79580' : '#fff',
                      paddingHorizontal: 20,
                      marginHorizontal: 2,
                      borderRadius: 10,
                      marginBottom: 10
              ...
              renderItem={({item}) => {
                return (
                  <TouchableOpacity
                    onFocus={() => this.onChangeText('')}
                    style={{
                      backgroundColor: this.state.paymentMode.uniqueName == item.uniqueName ? '#00B79580' : '#fff',
                      paddingHorizontal: 20,
                      marginHorizontal: 2,
                      borderRadius: 10,
                    }}
        ...
        {this.state.expandedBalance && (
          <View style={{ margin: 16 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              <Text style={{ color: '#1C1C1C', fontFamily: FONT_FAMILY.semibold }}>{this.state.currencySymbol + Number(this.state.balanceDetails.totalTaxableAmount).toFixed(2)}</Text>
            </View>
            {(this.state.balanceDetails.mainTaxAmount > 0)
              ? (
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                  <Text style={{ color: '#1C1C1C', fontFamily: FONT_FAMILY.semibold }}>{'Tax'}</Text>
                  <Text style={{ color: '#1C1C1C', fontFamily: FONT_FAMILY.semibold }}>{this.state.currencySymbol + Number(this.state.balanceDetails.mainTaxAmount).toFixed(2)}</Text>
                </View>)
              : null}
            {(this.state.selectedArrayType.includes('tdspay') ||
              this.state.selectedArrayType.includes('tdsrc'))
              ? (
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                  ...
                  <Text style={{ color: '#1C1C1C', fontFamily: FONT_FAMILY.semibold }}>{'- ' + this.state.currencySymbol + Number(this.state.balanceDetails.tdsOrTcsTaxAmount).toFixed(2)}</Text>
                </View>)
              : null}
            {
...

            {
              this.state.amountForReceipt != 0 && this.state.amountForReceipt != ''
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                  ...
                  <Text style={{ color: '#1C1C1C', fontFamily: FONT_FAMILY.semibold }}>{this.state.currencySymbol + Number(this.state.amountForReceipt).toFixed(2)}</Text>
                </View>)
                : null
            }
          </View>
