...
class EditItemDetails extends Component {
  ...
  getHierarchicalResolvedTaxRows(itemDetails) {
    ...
    // (stock.taxes -> stock.groupTaxes -> line.taxes -> line.groupTaxes), matching CreditNote.
    const resolvedNames = [
        ...
        <TouchableOpacity
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <Text style={{ marginLeft: 10, color: this.props.discountArray.length > 0 ? 'black' : '#808080' }}>
              {this.props.t('creditNote.discount')}
            </Text>
          </View>
        ...
        <View style={{ marginHorizontal: 16, flex: 1, paddingVertical: 10 }}>
          <TouchableOpacity
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              <Text style={{ marginLeft: 10, color: this.props.taxArray.length > 0 ? 'black' : '#808080' }}>{this.props.t('creditNote.tax')}</Text>
            </View>
