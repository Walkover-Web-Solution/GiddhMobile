...
class EditItemDetails extends Component {
      ...
      <BottomSheet
        ...
        flatListProps={{
          ...
          renderItem: ({ item }) => {
            ...
            console.log(this.props.itemDetails?.percentDiscountArray)
            return (
              <TouchableOpacity
  ...
  */
  ...
  fixedDiscountValueChange = (text) => {
    ...
    // editItemDetails.fixedDiscount.name = ''
    // editItemDetails.fixedDiscount.uniqueName = ''
    // editItemDetails.fixedDiscount.linkAccount = undefined
  ...
  _renderDescriptionField() {
    return (
      <TextInput
        placeholder={this.props.t('editItemDetails.addDescription')}
        multiline={true}
        numberOfLines={10}
...
const EditItemDetailsWrapper = (props) => {
