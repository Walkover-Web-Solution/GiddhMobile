...
export const AccountsUrls = {
  ...
  getAccountNames: createEndpoint('company/:companyUniqueName/v2/account-search?q=:accountName&page=:page&withStocks=:withStocks&stockAccountUniqueName=:stockAccountUniqueName&branchUniqueName=:branchUniqueName&lang=en'),
  ...
  getAdjustmentInvoices: createEndpoint(
    'company/:companyUniqueName/vouchers/invoice-list?voucherDate=:voucherDate&adjustmentRequest=true&count=50&page=:pageNumber&number=&voucherVersion=:voucherVersion&branchUniqueName=:branchUniqueName&lang=en'
    ),
}
