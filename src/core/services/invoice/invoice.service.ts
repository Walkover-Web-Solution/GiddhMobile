...
export class InvoiceService {
  ...
  static searchSpecified(companyUniqueName: any, branchUniqueName: any, query: string, page: number, group: string, withStocks: boolean) {
    return httpInstance
      .get(
        invoiceUrls.search
  ...
  static PbsearchSpecified(companyUniqueName: any, branchUniqueName: any, query: string, page: number, group: string) {
    return httpInstance
      .get(
        invoiceUrls.purchaseBillsearch
          .replace(':companyUniqueName', companyUniqueName)
  ...
  static getWareHouseSpecified(companyUniqueName: any, branchUniqueName: any) {
    return httpInstance
      .get(
        invoiceUrls.getWareHouse
          .replace(':companyUniqueName', companyUniqueName)
          .replace(':branchUniqueName', branchUniqueName)
        , {})
      .then((res) => {
  ...
  static getDiscountsSpecified(companyUniqueName: any, branchUniqueName: any) {
    return httpInstance
      .get(
  ...
  static getTaxesSpecified(companyUniqueName: any, branchUniqueName: any) {
    return httpInstance
      .get(
  ...
  static getBriefAccountSpecified(companyUniqueName: any, branchUniqueName: any) {
    return httpInstance
      .get(
        invoiceUrls.getBriefAccount
          .replace(':companyUniqueName', companyUniqueName)
          .replace(':branchUniqueName', branchUniqueName)
        , {})
      .then((res) => {
