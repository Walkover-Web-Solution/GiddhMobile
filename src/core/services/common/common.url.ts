...
export const commonUrls = {
  ...
  getLastVouchers : createEndpoint('company/:companyUniqueName/vouchers/get-all?count=:count&sort=desc&sortBy=voucherDate&type=:voucherType&voucherVersion=:voucherVersion&branchUniqueName=:branchUniqueName&lang=en'),
